		...
		if ((isset($_GET["codice"]) || isset($_GET["cod"]))) {
			...
			die();
				...
				if ($_SESSION["gerarchia"] > 0) {
					...
					$strsql .= "AND (codice_ente = '" . $_SESSION["record_utente"]["codice_ente"] . "' OR codice_gestore = '" . $_SESSION["record_utente"]["codice_ente"] . "') ";
				}
				...
				if ($risultato->rowCount() > 0) {
					...
					if ($risultato_cpv->rowCount()>0) {
						...
						$operazione = "UPDATE";
							...
							$lock = false;
							$record = get_campi("b_bandi_mercato");
							$operazione = "INSERT";
							$string_cpv = "";
					}
?>
                    ...
                    <div id="generali"><table width="100%">
                       ...
                       <tr>
                        ...
                        <td><input type="text" class="datetimepick" id="data_scadenza" name="bando[data_scadenza]" title="Data scadenza" value="<? echo mysql2datetime($record["data_scadenza"]) ?>" rel="S;16;16;DT"></td>
												...
												<td><input type="text" id="periodo_revisione" name="bando[periodo_revisione]" title="Revisione" value="<? echo $record["periodo_revisione"] ?>" rel="S;0;2;N"></td>
                       </tr>
    	                <tr>
