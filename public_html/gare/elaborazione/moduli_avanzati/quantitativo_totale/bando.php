	...
	if (count($ris_importi)>0) {
		...
		foreach($ris_importi AS $rec_importo) {
			...
			/* if ($offerta == "netto") {
				...
				$html.= "<tr><td style=\"width:5%\">" . $importi_i . ".c)</td><td style=\"text-align:right\" style=\"width:25%\">&euro; " .  number_format($rec_importo["importo_personale"],2,",",".") . "</td><td style=\"width:70%\">Costo della manodopera soggetti a ribasso;</td></tr>";
			// }
		}
		$html.= "</table>";
	}
