...
;
  ...
  $record_pubblicita = get_campi("b_pubblicita_legale");
  $id = $_POST["id"];
}
$lock = false;
?>
<tr id="pubblicita_<?=$id?>">
  ...
  <td width="2%"><input type="image" src="/img/del.png" onClick="elimina('<? echo $id ?>','gare/pubblicita_legale'); return false;" name="elimina_<? echo $id; ?>" width="35px" height="auto" /></td>
</tr>
