<?
	...
	if (!$edit) {
		...
		if (isset($_POST["codice"])) {
			...
			log_gare($_SESSION["ente"]["codice"],$record["codice_gara"],"DELETE","Modello verbale seduta");
			?>
				alert("Rielaborazione effettuata con successo");
				window.location.href = '/gare/verbali_sedute/index.php?codice=<? echo $record["codice_gara"] ?>';
		   <?
		}
	}
