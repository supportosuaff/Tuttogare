<?
  if (isset($record) && isset($st_index)) {
    ...
    $strsql_check = "SELECT codice,bozza FROM b_documentale WHERE tipo= 'avviso_appalto_aggiudicato' AND attivo = 'S' AND sezione = 'gara' AND codice_gara = :codice AND codice_lotto = :codice_lotto ";
