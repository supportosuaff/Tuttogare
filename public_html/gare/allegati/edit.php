	...
	$lock = true;
		if ((isset($_GET["codice"]) || isset($_GET["cod"]))) {
				...
				if ($risultato->rowCount() > 0) {
					...
					$sql = "SELECT * FROM b_allegati WHERE codice_gara = :codice AND sezione = 'gara' AND online = 'N' ORDER BY cartella, codice";
...
?>
	      ...
	      <button onClick="open_allegati();return false;" style="width:100%; padding:10px; background-color:#F60" class="submit">
				...
				<?
					...
					if ($_SESSION["gerarchia"] > 0 && $_SESSION["ente"]["codice"] != $_SESSION["record_utente"]["codice_ente"]) $form_upload["online"] = "N";
