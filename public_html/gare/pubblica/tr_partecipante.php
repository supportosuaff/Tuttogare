<?
  ...
  <tr id="partecipante-<?= $id ?>">
    <td>
      ...
      <input type="text"class="partita_iva" size="16" name="partecipanti[<?= $id ?>][partita_iva]" title="Codice fiscale" rel="S;8;0;PICF" id="partecipante-<?= $id ?>-partita_iva">
    </td>
    <td><input style="width:99%" type="text" name="partecipanti[<?= $id ?>][identificativoEstero]" onChange="if ($(this).val() != '') { $('#partecipante-<?= $id ?>-partita_iva').attr('rel','N;8;0;PICF'); } else { $('#partecipante-<?= $id ?>-partita_iva').attr('rel','S;8;0;PICF'); }"  title="Identificativo fiscale estero" rel="N;5;0;A" id="partecipante-<?= $id ?>-identificativoEstero"></td>
    ...
    <td><input type="text" style="width:99%" name="partecipanti[<?= $id ?>][pec]" title="Pec" rel="S;3;255;E" id="partecipante-<?= $id ?>-pec"></td>
    <td>
