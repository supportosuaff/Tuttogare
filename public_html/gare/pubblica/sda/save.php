			...
			if ($risultato->rowCount()>0) {
				...
				if ((isset($_POST["gara"]["pubblica"]) && $_POST["gara"]["pubblica"] == "1") || ($record_gara["pubblica"] == "1") || (isset($_POST["gara"]["pubblica"]) && $_POST["gara"]["pubblica"] == "2") || ($record_gara["pubblica"] == 2)) {
					...
					if (isset($_POST["indirizzi"]) && $_POST["indirizzi"] != "") {
						...
						$strsql .= "JOIN r_partecipanti_sda ON b_utenti.codice = r_partecipanti_sda.codice_utente ";
						$strsql .= "WHERE b_gruppi.gerarchia > 2 AND b_utenti.attivo = 'S' AND r_enti_operatori.cod_ente = :codice_ente AND r_partecipanti_sda.ammesso = 'S' and r_partecipanti_sda.codice_bando = :codice_derivazione ";
