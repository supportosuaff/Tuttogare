...
(function(window, document, $, undefined)
 {
    window.ResumableUploader = function(browseTarget) {
     ...
     this.newResumable = function(){
       ...
       this.resumable.on('fileAdded', function(file){
		   var allReg = /\.(p7m|pdf|P7M|PDF)$/;	// espressione regolare per il controllo dei file allegati
    ...
    loadNext();
			  ...
			  jalert("<div style=\"text-align:center\">Impossibile caricaricare il file<br><br><strong>" + file.fileName + "</strong></br><br>La tipologia pu&ograve; solo essere: P7M o PDF firmato</div>");
