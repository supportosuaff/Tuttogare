  ...
  if ($edit) {
    ...
    if ($ris->rowCount()>0) {
      ...
      if ($ris->rowCount()>0) {
        ...
        $msg .= " - Somma: " . $somma . " - Media: " . $media . " - Scarto Medio: " . $scarto_medio . " - Decremento soglia: " . $ribasso_soglia . " - Soglia di anomalia: " . $soglia_anomalia . "  - Interpretazione art. 97 c. 2 lett. d: ";
        if (empty($_POST["interpretazione_anomalia"]) || $_POST["interpretazione_anomalia"] == "M") {
