<?
	...
	if (!$edit) {
		...
		if (isset($_POST["codice"])) {
			...
			log_gare($_SESSION["ente"]["codice"],$record["codice_gara"],"DELETE","Modello graduatoria provvisoria");
			?>
             alert("Rielaborazione effettuata con successo");
             window.location.href = '/gare/agg_provvisoria/prospetto.php?codice=<? echo $record["codice_gara"] ?>';
		   <?
		}
	}
