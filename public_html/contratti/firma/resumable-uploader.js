...
(function(window, document, $, undefined)
 {
    window.ResumableUploader = function(browseTarget,type) {
     var $this = this;
     ...
     this.newResumable = function(){
      ...
      this.resumable.on('fileAdded', function(file){
        ...
        if (allReg.test(file.fileName)) {
          ...
          if (type=="pdf") {
            var tipo = "PDF";	// espressione regolare per il controllo dei file allegati
          } else {
            var tipo = "PDF o P7M";	// espressione regolare per il controllo dei file allegati
          }
          jalert("<div style=\"text-align:center\">Impossibile caricaricare il file<br><br><strong>" + file.fileName + "</strong></br><br>La tipologia pu&ograve; solo essere: PDF o P7M</div>");
