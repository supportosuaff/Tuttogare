...
?>
<h2 style="text-align: right;"><b>Risultati di concorso di progettazione</b></h2>
<input type="hidden" name="tipologia_form" value="F13_2014">
<input type="hidden" name="numero_form" value="132">
...
<input type="hidden" name="attributi_form[FORM]" value="F13">
...
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f132";
	...
	$f02 = array(
		...
		3 => array(
			...
			1 => array(
				0 => array(
					...
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_4_1_2_f13.php",
		...
		4 => array(
			0 => "<h2><b>Sezione V: Risultati del concorso</b></h2>",
