...
?>
<h2 style="text-align: right;"><b>Avviso di concorso di progettazione</b></h2>
<input type="hidden" name="tipologia_form" value="F12_2014">
<input type="hidden" name="numero_form" value="122">
...
<input type="hidden" name="attributi_form[FORM]" value="F12">
<input type="hidden" name="attributi_form[LG]" value="IT">
<input type="hidden" name="guue[DIRECTIVE][ATTRIBUTE][VALUE]" value="2014/25/EU">
<p style="text-align: right;">
	<i>Direttiva 2014/25/UE</i>
</p>
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f122";
		...
		2 => array(
			...
			1 => array(
				...
				1 => array(
					...
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_3_2_1_f12.php",
		...
		3 => array(
			...
			1 => array(
				0 => array(
					...
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_4_1_2.php",
					3 => "sezioni/sezione_4_1_7.php",
					4 => "sezioni/sezione_4_1_9.php",
					8 => '</tbody></table>',
					),
				1 => array(
				...
				2 => array(
					0 => "<h3><b>IV.3) Premi e commissione giudicatrice</b></h3>",
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_4_3_1.php",
					3 => "sezioni/sezione_4_3_2.php",
					4 => "sezioni/sezione_4_3_3.php",
					5 => "sezioni/sezione_4_3_4.php",
					6 => "sezioni/sezione_4_3_5.php",
					8 => '</tbody></table>',
					),
				)
			),
