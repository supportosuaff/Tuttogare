...
<tr>
	<td colspan="4" id="award_criteria_item_to_ignore_<?= $item ?>"><button class="aggiungi" type="button" onClick="aggiungi('forms/2_0_9/common/criteri_di_aggiudicazione_2_2_5_f06.php','#award_criteria_item_to_ignore_<?= $item ?>', {item:'<?= $item ?>'});return false;"><img src="/img/add.png" alt="Aggiungi committente">Aggiungi criterio</button><?
