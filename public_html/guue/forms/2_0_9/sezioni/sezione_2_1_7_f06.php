			...
			<tbody>
				<tr>
					<td class="etichetta">
						...
						?>
						<label style="font-size: 14px;"><input <?= !empty($total_val) ? 'checked="checked"' : null ?> type="radio" name="valore_totale_appalto" onchange="toggle_field($(this), ['#valore_totale_appalto','#val_total_currency', '#val_total_pubblication']);"> Valore totale:</label>
					</td>
					<td>
						<input type="hidden" name="guue[OBJECT_CONTRACT][VAL_TOTAL][ATTRIBUTE][PUBLICATION]" id="val_total_pubblication" value="NO" <?= !$total_val ? 'disabled="disabled"' : null ?>>
					...
					<td colspan="2">
						<input type="text" name="guue[OBJECT_CONTRACT][VAL_TOTAL][val]" style="font-size: 1.3em" title="Valore totale" <?= empty($total_val) ? 'disabled="disabled"' : null ?> id="valore_totale_appalto" rel="" value="<?= !empty($guue["OBJECT_CONTRACT"]["VAL_TOTAL"]["val"]) ? $guue["OBJECT_CONTRACT"]["VAL_TOTAL"]["val"] : null ?>">
					</td>
				</tr>
				<tr>
					<td colspan="4">
				...
				<tr>
					<td class="etichetta">
						...
						?>
						<label style="font-size: 14px;"><input <?= !empty($max_and_min_val) ? 'checked="checked"' : null ?> type="radio" name="valore_totale_appalto" onchange="toggle_field($(this), ['#valore_offerta_bassa', '#valore_offerta_alta', '#val_range_total_currency', '#val_range_pubblication']);"> Valore totale:</label>
					</td>
					<td>
						<input type="hidden" name="guue[OBJECT_CONTRACT][VAL_RANGE_TOTAL][ATTRIBUTE][PUBLICATION]" id="val_range_pubblication" value="NO" <?= !$max_and_min_val ? 'disabled="disabled"' : null ?>>
					...
					<td>
						<input type="text" name="guue[OBJECT_CONTRACT][VAL_RANGE_TOTAL][LOW]" style="font-size: 1.3em" title="Offerta pi&ugrave; bassa" <?= empty($max_and_min_val) ? 'disabled="disabled"' : null ?> id="valore_offerta_bassa" rel="" value="<?= !empty($guue["OBJECT_CONTRACT"]["VAL_RANGE_TOTAL"]["LOW"]) ? $guue["OBJECT_CONTRACT"]["VAL_RANGE_TOTAL"]["LOW"] : null ?>">
					</td>
					<td>
						<input type="text" name="guue[OBJECT_CONTRACT][VAL_RANGE_TOTAL][HIGH]" style="font-size: 1.3em" title="Offerta pi&ugrave; alta" <?= empty($max_and_min_val) ? 'disabled="disabled"' : null ?> id="valore_offerta_alta" rel="" value="<?= !empty($guue["OBJECT_CONTRACT"]["VAL_RANGE_TOTAL"]["HIGH"]) ? $guue["OBJECT_CONTRACT"]["VAL_RANGE_TOTAL"]["HIGH"] : null ?>">
					</td>
				</tr>
			</tbody>
		</table>
