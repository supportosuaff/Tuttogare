...
<tr>
	<td colspan="4" class="etichetta">
		<label>Metodo utilizzato per calcolare il valore stimato della concessione: (se non specificato in altri documenti relativi alla concessione)</label>
	</td>
</tr>
<tr>
	<td colspan="4">
		<input type="text" name="guue[OBJECT_CONTRACT][CALCULATION_METHOD]" value="<?= !empty($guue["OBJECT_CONTRACT"]["CALCULATION_METHOD"]) ? $guue["OBJECT_CONTRACT"]["CALCULATION_METHOD"] : null ?>" rel="<?= isRequired("CALCULATION_METHOD") ?>;0;400;A" title="Metodo utilizzato per calcolare il valore stimato della concessione">
	</td>
</tr>