...
<tr>
	<td colspan="4">
		...
		if(!empty($guue["PROCEDURE"]["DIRECTIVE_2014_23_EU"]["radio_as_select_for_procedure_type"])) {
			$radio_as_select_for_procedure_type = $guue["PROCEDURE"]["DIRECTIVE_2014_23_EU"]["radio_as_select_for_procedure_type"];
		}
		?>
		<select id="radio_as_select_for_procedure_type" name="guue[PROCEDURE][DIRECTIVE_2014_23_EU][radio_as_select_for_procedure_type]" rel="S;1;0;A" onchange="add_extra_info($(this).val(), radio_as_select_for_procedure_type_options)">
			<option value="">Seleziona..</option>
			<option <?= $radio_as_select_for_procedure_type == "PT_AWARD_CONTRACT_WITHOUT_PUBLICATION" ? 'selected="selected"' : null ?> value="PT_AWARD_CONTRACT_WITHOUT_PUBLICATION">Aggiudicazione di una concessione senza previa pubblicazione di un bando di concessione (in conformit&agrave; dell&#39;articolo 31, paragrafi 4 e 5, della direttiva 2014/23/UE)</option>
