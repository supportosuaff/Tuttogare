...
?>
<h2 style="text-align: right;"><b>Avviso periodico indicativo – Servizi di pubblica utilit&agrave;</b></h2>
<input type="hidden" name="tipologia_form" value="F04_2014">
<input type="hidden" name="numero_form" value="042">
...
<input type="hidden" name="attributi_form[FORM]" value="F04">
<input type="hidden" name="attributi_form[LG]" value="IT">
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="PER_REDUCING_TIME_LIMITS">
<p style="text-align: right;" title="Tipologia di Avviso">
	Direttiva 2014/25/UE<br>
	<label>Lo scopo del presente avviso &egrave; ridurre i termini per la ricezione delle offerte</label>
</p>
<?
	$rel = array(
		"ADDRS1-OFFICIALNAME",
	...
	$_SESSION["guue"]["numero_del_form"] = "f04-2";
		...
		if($ris->rowCount() > 0) {
			...
			while ($rec = $ris->fetch(PDO::FETCH_ASSOC)) {
				$f01[1][1][3][2][] = array(
					...
					13 => '</tbody></table><div id="padding_lot_no_'.$j.'" class="padding"></div><script>var lot = '.$j.';</script>',
				);
				$j++;
			}
		}
