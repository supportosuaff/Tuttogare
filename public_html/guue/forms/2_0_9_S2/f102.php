...
<input type="hidden" name="numero_form" value="102">
...
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="PRI_REDUCING_TIME_LIMITS">
...
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f01-2";
