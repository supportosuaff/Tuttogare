<?
	...
	$unset_title = FALSE;
	$lot_division = !empty($_POST["guue"]["OBJECT_CONTRACT"]["radio_as_select_for_lot_division"]) ? $_POST["guue"]["OBJECT_CONTRACT"]["radio_as_select_for_lot_division"] : null;
	if(!empty($lot_division) && $lot_division == "NO_LOT_DIVISION") {
		$unset_title = TRUE;
	}
