...
<tr>
	<td colspan="4">
		...
		if(!empty($guue["PROCEDURE"]["radio_as_select_for_procedure_type"])) {
			...
			$pt_competitive_negotiation = $guue["PROCEDURE"]["radio_as_select_for_procedure_type"] == "PT_COMPETITIVE_NEGOTIATION" ? TRUE : FALSE;
		}
		?>
		<select name="guue[PROCEDURE][radio_as_select_for_procedure_type]" rel="<?= isRequired("radio_as_select_for_procedure_type") ?>;1;0;A">
			...
			<option <?= $pt_competitive_negotiation ? 'selected="selected"' : null ?> value="PT_COMPETITIVE_NEGOTIATION">Procedura competitiva con negoziazione</option>
		</select>
	</td>
</tr>