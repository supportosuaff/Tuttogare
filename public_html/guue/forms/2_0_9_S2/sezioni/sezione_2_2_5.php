...
<tr>
	<td colspan="4">
		...
		if(!empty($guue["OBJECT_CONTRACT"]["OBJECT_DESCR"]["ITEM_".$item]["radio_as_select_for_award_criteria_doc"])) {
			$award_criteria_item_to_ignore = $guue["OBJECT_CONTRACT"]["OBJECT_DESCR"]["ITEM_".$item]["radio_as_select_for_award_criteria_doc"] == "AWARD_CRITERIA_ITEM_TO_IGNORE" ? TRUE : FALSE;
