				...
				<tr>
					<td class="etichetta" colspan="4">
						<label style="font-size: 14px;">
							<input type="checkbox" <?= !empty($guue["OBJECT_CONTRACT"]["OBJECT_DESCR"]["ITEM_".$item]["JUSTIFICATION"]) ? 'checked="checked"' : null ?> onChange="toggle_field($(this), '#item_<?= $item ?>_justification')"> Direttiva 2014/24/UE – In caso di accordi quadro – giustificazione per una durata superiore a 4 anni:
						</label>
					</td>
				</tr>
				<tr>
