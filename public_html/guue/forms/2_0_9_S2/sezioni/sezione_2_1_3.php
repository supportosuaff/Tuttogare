<tr>
	...
	<td colspan="3">
		<select name="guue[OBJECT_CONTRACT][TYPE_CONTRACT][ATTRIBUTE][CTYPE][radio_as_select_for_type_contract]" rel="<?= isRequired("radio_as_select_for_type_contract") ?>;1;0;A" title="Tipo di Appalto">
			...
			<option <?= (!empty($guue["OBJECT_CONTRACT"]["TYPE_CONTRACT"]["ATTRIBUTE"]["CTYPE"]["radio_as_select_for_type_contract"]) && $guue["OBJECT_CONTRACT"]["TYPE_CONTRACT"]["ATTRIBUTE"]["CTYPE"]["radio_as_select_for_type_contract"] == "SUPPLIES") ? 'selected="selected"' : null ?> value="SUPPLIES" >Forniture</option>
