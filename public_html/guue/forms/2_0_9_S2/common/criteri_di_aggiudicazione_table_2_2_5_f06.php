	...
	<tr>
		...
		<?
			if(!empty($type) && $type == "AC_QUALITY") {
				include "criterio_di_qualita_2_2_5_f06.php";
			} elseif (!empty($type) && $type == "AC_COST") {
				include "criterio_costo_2_2_5_f06.php";
			} elseif (!empty($type) && $type == "AC_PRICE") {
				include "criterio_prezzo_2_2_5_f06.php";
			}
		?>
		</td>
		<td style="width: 20px;">
