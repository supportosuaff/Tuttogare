...
<input type="hidden" name="numero_form" value="225">
...
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="CONTRACT">
<p style="text-align: right;" >
	Direttiva 2014/25/UE<br>
	<label>Bando di gara</label>
</p>
<?
	$rel = array(
		"ADDRS1-OFFICIALNAME",
	...
	$_SESSION["guue"]["numero_del_form"] = "f22-5";
