...
<input type="hidden" name="numero_form" value="151">
...
<input type="hidden" name="guue[DIRECTIVE][ATTRIBUTE][VALUE]" value="2014/23/UE">
<p style="text-align: right; margin-top: 0px">Risultati della procedura di appalto<br>Direttiva 2014/23/UE</p>
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f15-1";
		...
		2 => array(
			...
			1 => array(
				0 => array(
					...
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_4_1_1_f15-2.php",
	...
	if(!empty($guue["PROCEDURE"]["DIRECTIVE_2014_23_EU"]["radio_as_select_for_procedure_type"])) {
		if($guue["PROCEDURE"]["DIRECTIVE_2014_23_EU"]["radio_as_select_for_procedure_type"] == "PT_AWARD_CONTRACT_WITHOUT_PUBLICATION") {
			$f03[5][1] = "sezioni/annex_d4_part1.php";
		} else if ($guue["PROCEDURE"]["DIRECTIVE_2014_23_EU"]["radio_as_select_for_procedure_type"] == "PT_AWARD_CONTRACT_WITHOUT_CALL") {
			$f03[5][1] = "sezioni/annex_part2.php";
		}
	}

	$_SESSION["guue"]["json_form"] = $f03;
	loadForm($f03, -1, "2_0_9_S3");
	?>
