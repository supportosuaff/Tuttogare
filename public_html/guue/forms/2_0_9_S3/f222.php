...
<input type="hidden" name="numero_form" value="222">
...
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="PER_CALL_COMPETITION">
<p style="text-align: right;">
	Direttiva 2014/25/UE<br>
	<label>
		Avviso periodico indicativo<br>
		Il presente avviso &egrave; un avviso di indizione di gara<br>
		<i>
			Gli operatori interessati devono informare l&#39;ente aggiudicatore del loro interesse per il contratto d'appalto.<br>
...
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f22-2";
		...
		3 => array(
			0 => "<h2><b>Sezione IV: Procedura</b></h2>",
				0 => array(
					...
					3 => "sezioni/sezione_4_1_3_f212.php",
