...
<input type="hidden" name="numero_form" value="223">
...
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="QSU_ONLY">
...
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f22-3";
		...
		2 => array(
			...
			1 => array(
				0 => array(
					...
					3 => "sezioni/sezione_3_1_5_f221.php",
      ...
      foreach ($guue["OBJECT_CONTRACT"]["OBJECT_DESCR"] as $key_lot => $lot) {
        if(strpos($key_lot,"ITEM_") !== FALSE) {
          $f22[1][1][3][2][] = array(
            ...
            6 => "sezioni/sezione_2_2_8_f22.php",
