...
<input type="hidden" name="numero_form" value="212">
...
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="PRI_CALL_COMPETITION">
<p style="text-align: right;" title="Tipologia di Avviso">
	Direttiva 2014/25/UE<br>
	<label>Avviso di preinformazione<br>Il presente avviso &egrave; un avviso di indizione di gara</label>
</p>
<?
	$rel = array(
		"ADDRS1-OFFICIALNAME",
	...
	$_SESSION["guue"]["numero_del_form"] = "f21-2";
