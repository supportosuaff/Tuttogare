...
?>
<h2 style="text-align: right;"><b>Servizi sociali e altri servizi specifici – Servizi di pubblica utilit&agrave;</b></h2>
<input type="hidden" name="tipologia_form" value="F22_2014">
<input type="hidden" name="numero_form" value="226">
...
<input type="hidden" name="attributi_form[FORM]" value="F22">
...
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="AWARD_CONTRACT">
<p style="text-align: right;" title="Tipologia di Avviso">
	Direttiva 2014/25/UE<br>
	<label>Avviso di aggiudicazione di appalto</label>
</p>
<?
	$rel = array(
		"ADDRS1-OFFICIALNAME",
	...
	$_SESSION["guue"]["numero_del_form"] = "f22-6";
			...
			0 => "<h2><b>Sezione II: Oggetto</b></h2>",
				1 => array(
					...
					2 => array(
						...
						7 => "sezioni/sezione_2_1_6_f03.php",
						9 => '<tr><td colspan="4"><span style="color:#C30">Se il contratto non &egrave; stato aggiudicato non deve essere specificato alcun valore per la sezione II.1.7</span></td></tr></tbody></table>',
						),
					3 => array(
		...
		3 => array(
			...
			1 => array(
				0 => array(
					...
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_4_1_1_f212.php",
					3 => "sezioni/sezione_4_1_3_f214.php",
