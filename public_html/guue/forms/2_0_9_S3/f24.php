...
?>
<h2 style="text-align: right;"><b>Bando di concessione</b></h2>
<input type="hidden" name="tipologia_form" value="F24_2014">
<input type="hidden" name="numero_form" value="24">
...
<input type="hidden" name="attributi_form[FORM]" value="F24">
...
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f24";
