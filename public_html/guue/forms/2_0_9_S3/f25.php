...
?>
<h2 style="text-align: right;"><b>Avviso di aggiudicazione di concessione</b><br>Risultati della procedura di appalto</h2>
<input type="hidden" name="tipologia_form" value="F25_2014">
<input type="hidden" name="numero_form" value="25">
...
<input type="hidden" name="attributi_form[FORM]" value="F25">
<input type="hidden" name="attributi_form[LG]" value="IT">
<input type="hidden" name="guue[LEGAL_BASIS][ATTRIBUTE][VALUE]" value="32014L0023">
<input type="hidden" name="guue[CONTRACTING_BODY]">
...
<?
	$rel = array(
		...
		"OBJECT_CONTRACT-TITLE-SECTION-II-1",
	...
	$_SESSION["guue"]["numero_del_form"] = "f25";
	...
	$f22 = array(
		0 => array(
			...
			1 => array(
				...
				// 1 => "sezioni/sezione_1_3.php",
				2 => "sezioni/sezione_1_4.php",
				3 => "sezioni/sezione_1_5.php",
			...
			0 => "<h2><b>Sezione II: Oggetto</b></h2>",
				1 => array(
					...
					2 => array(
						...
						4 => "sezioni/sezione_2_1_3_f203.php",
						5 => "sezioni/sezione_2_1_4.php",
						6 => "sezioni/sezione_2_1_5_f25.php",
						7 => "sezioni/sezione_2_1_7.php",
						8 => '<tr><td colspan="4"><span style="color:#C30">Se il contratto non &egrave; stato aggiudicato non deve essere specificato alcun valore per la sezione II.1.7</span></td></tr>',
						9 => "sezioni/sezione_2_1_6_f03.php",
						10 => '</tbody></table>',
						),
					3 => array(
		...
		3 => array(
			...
			1 => array(
				0 => array(
					...
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_4_1_1_f25.php",
					3 => "sezioni/sezione_4_1_8.php",
					// 4 => "sezioni/sezione_4_1_6.php",
					// 4 => "sezioni/sezione_4_1_10.php",
					5 => "sezioni/sezione_4_1_11.php",
					6 => '</tbody></table>',
					),
				1 => array(
					...
					// 6 => "sezioni/sezione_4_2_9_f214.php",
					7 => '</tbody></table>',
					),
				)
			),
		4 => array(
			...
			4 => "common/more_lots_button_award_f25.php",
			),
		5 => array(
      ...
      foreach ($guue["OBJECT_CONTRACT"]["OBJECT_DESCR"] as $key_lot => $lot) {
        if(strpos($key_lot,"ITEM_") !== FALSE) {
          $f22[1][1][3][2][] = array(
            ...
            6 => "sezioni/sezione_2_2_5_f25.php",
            // 7 => "sezioni/sezione_2_2_6.php",
            8 => "sezioni/sezione_2_2_7_f203.php",
		...
		$f22[1][1][3][2][] = array(
			...
			11 => "sezioni/sezione_2_2_13.php",
			12 => "sezioni/sezione_2_2_14.php",
			14 => '</tbody></table><div id="padding_lot_no_1" class="padding"></div><script>var lot = 1;</script>',
		);
