...
?>
<h2 style="text-align: right;"><b>Bando di Gara - Servizi di pubblica utilit&agrave;</b></h2>
<input type="hidden" name="tipologia_form" value="F05_2014">
<input type="hidden" name="numero_form" value="5">
...
<input type="hidden" name="attributi_form[FORM]" value="F05">
...
<!-- <table style="width: 100%; margin-top: 20px;">
	<tbody>
		<tr>
			<td class="etichetta"><label>Data prevista per la pubblicazione:</label></td>
			<td><input type="text" name="guue[DATE_EXPECTED_PUBLICATION]" rel="S;0;0;D" class="datepick" value="<?= !empty($guue["DATE_EXPECTED_PUBLICATION"]) ? $guue["DATE_EXPECTED_PUBLICATION"] : null ?>" title="Data prevista per la pubblicazione"></td>
		</tr>
	</tbody>
</table> -->
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f05";
	...
	$f05 = array(
		...
		2 => array(
			...
			1 => array(
				0 => array(
					...
					5 => "sezioni/sezione_3_1_4.php",
					6 => "sezioni/sezione_3_1_5.php",
					7 => "sezioni/sezione_3_1_6.php",
					8 => "sezioni/sezione_3_1_7.php",
					9 => "sezioni/sezione_3_1_8.php",
					10 => '</tbody></table>',
					),
				1 => array(
		...
		3 => array(
			...
			1 => array(
				0 => array(
					...
					4 => "sezioni/sezione_4_1_4.php",
					6 => "sezioni/sezione_4_1_6.php",
				...
				1 => array(
					...
					4 => "sezioni/sezione_4_2_3.php",
					5 => "sezioni/sezione_4_2_4.php",
					6 => "sezioni/sezione_4_2_6.php",
					7 => "sezioni/sezione_4_2_7.php",
					8 => '</tbody></table>',
					),
				)
			),
		4 => array(
			...
			1 => array(
				0 => "sezioni/sezione_6_1.php",
				1 => "sezioni/sezione_6_2.php",
				...
				foreach ($guue["OBJECT_CONTRACT"]["OBJECT_DESCR"] as $key_lot => $lot) {
					if(strpos($key_lot,"ITEM_") !== FALSE) {
						$f05[1][1][2][2][] = array(
							...
							6 => "sezioni/sezione_2_2_6.php",
							7 => "sezioni/sezione_2_2_7_f02.php",
							8 => "sezioni/sezione_2_2_9.php",
							9 => "sezioni/sezione_2_2_10_f02.php",
							10 => "sezioni/sezione_2_2_11_f02.php",
							11 => "sezioni/sezione_2_2_12.php",
	...
	$_SESSION["guue"]["json_form"] = $f05;
	loadForm($f05, -1, "2_0_9_S3");
	?>
