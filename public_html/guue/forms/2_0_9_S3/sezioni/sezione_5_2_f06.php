...
<table class="bordered bigger">
	...
	<tr>
		...
		<td colspan="2">
			<? $award_contract_value_publication = !empty($guue["AWARD_CONTRACT"]["ITEM_".$item]["AWARDED_CONTRACT"]["VALUES"]["ATTRIBUTE"]["PUBLICATION"]) ? $guue["AWARD_CONTRACT"]["ITEM_".$item]["AWARDED_CONTRACT"]["VALUES"]["ATTRIBUTE"]["PUBLICATION"] : ""; ?>
			<select name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][ATTRIBUTE][PUBLICATION]" rel="S;1;0;A" title="Consentire la pubblicazione">
				<option value="">Seleziona..</option>
				...
				<tbody>
					<tr>
						...
						if(!empty($guue["AWARD_CONTRACT"]["ITEM_".$item]["AWARDED_CONTRACT"]["VALUES"]["VAL_TOTAL"]["val"])) {
							$valore_totale = TRUE;
							$valore_valore_totale = $guue["AWARD_CONTRACT"]["ITEM_".$item]["AWARDED_CONTRACT"]["VALUES"]["VAL_TOTAL"]["val"];
						}
						?>
						<td class="etichetta">
						...
						<td colspan="2">
							<input id="valore_totale_del_contaratto_item_<?= $item ?>_currency" <?= !$valore_totale ? 'disabled="disabled"' : null ?> type="hidden" name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_TOTAL][ATTRIBUTE][CURRENCY]" value="EUR">
							<input type="text" title="Valore Totale" name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_TOTAL][val]" <?= !$valore_totale ? 'disabled="disabled"' : null ?> value="<?= $valore_valore_totale ?>" id="valore_totale_del_contaratto_item_<?= $item ?>_duration" rel="S;1;0;A">
						</td>
					</tr>
					<tr>
						<?
						...
						<td class="etichetta" style="width:350px;">
							...
							<input id="item_<?= $item ?>_val_range_total_currency" type="hidden" <?= !$val_range_total ? 'disabled="disabled"' : null ?> name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_RANGE_TOTAL][ATTRIBUTE][CURRENCY]" value="EUR">
						</td>
						<td>
							<input type="text" title="Offerta pi&ugrave; bassa" value="<?= $valore_val_range_total_low ?>" name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_RANGE_TOTAL][LOW]" <?= !$val_range_total ? 'disabled="disabled"' : null ?> id="item_<?= $item ?>_valore_val_range_total_low" rel="S;1;0;D">
						</td>
						<td>
							<input type="text" title="Offerta pi&ugrave; bassa" value="<?= $valore_val_range_total_high ?>" name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_RANGE_TOTAL][HIGH]" <?= !$val_range_total ? 'disabled="disabled"' : null ?> id="item_<?= $item ?>_valore_val_range_total_high" rel="S;1;0;D">
						</td>
					</tr>
					<tr>
						<td class="etichetta" colspan="4">
