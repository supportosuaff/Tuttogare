		...
		<table class="bordered valida" title="Valore totale dell&#39;appalto" rel="<?= isRequired("valore_totale_appalto") ?>;0;0;checked;group_validate">
			<tbody>
				<tr>
					...
					<td colspan="2">
						<input type="text" name="guue[OBJECT_CONTRACT][VAL_TOTAL][val]" style="font-size: 1.3em" title="Valore totale" <?= empty($total_val) ? 'disabled="disabled"' : null ?> id="valore_totale_appalto" rel="S;2;0;2D" value="<?= !empty($guue["OBJECT_CONTRACT"]["VAL_TOTAL"]["val"]) ? $guue["OBJECT_CONTRACT"]["VAL_TOTAL"]["val"] : null ?>">
					</td>
				</tr>
				<tr>
					<td colspan="4">
