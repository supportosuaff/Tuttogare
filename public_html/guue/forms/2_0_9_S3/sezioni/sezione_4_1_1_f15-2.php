...
<tr>
	<td colspan="4">
		<script type="text/javascript">
			var radio_as_select_for_procedure_type_options = {
				'PT_NEGOTIATED_WITHOUT_PUBLICATION' : [
					'ajax_load',
					['sezioni', 'annex_d1_part1'],
					[],
					'allegato_d'
				],
				'PT_AWARD_CONTRACT_WITHOUT_CALL' : [
					'ajax_load',
					['sezioni', 'annex_d1_part2'],
					[],
					'allegato_d'
				]
			}
		...
		if(!empty($guue["PROCEDURE"]["DIRECTIVE_2014_24_EU"]["radio_as_select_for_procedure_type"])) {
			$radio_as_select_for_procedure_type = $guue["PROCEDURE"]["DIRECTIVE_2014_24_EU"]["radio_as_select_for_procedure_type"];
		}
		?>
		<select id="radio_as_select_for_procedure_type" name="guue[PROCEDURE][DIRECTIVE_2014_24_EU][radio_as_select_for_procedure_type]" rel="S;1;0;A" onchange="add_extra_info($(this).val(), radio_as_select_for_procedure_type_options)">
