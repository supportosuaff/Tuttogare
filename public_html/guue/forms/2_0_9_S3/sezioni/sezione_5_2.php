...
<table class="bordered bigger">
	...
	<tr>
		<td colspan="4">
				...
				<tbody>
					<tr>
						...
						<td colspan="2">
							...
							<input type="text" title="Valore Totale" name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_TOTAL][val]" <?= !$valore_totale ? 'disabled="disabled"' : null ?> value="<?= $valore_valore_totale ?>" id="valore_totale_del_contaratto_item_<?= $item ?>_duration" rel="S;1;0;2D">
						</td>
					</tr>
					<tr>
						<?
						...
						if(!empty($guue["AWARD_CONTRACT"]["ITEM_".$item]["VAL_RANGE_TOTAL"]["HIGH"]) && !empty($guue["AWARD_CONTRACT"]["ITEM_".$item]["VAL_RANGE_TOTAL"]["LOW"])) {
							...
							$valore_val_range_total_low = $guue["AWARD_CONTRACT"]["ITEM_".$item]["VALUES"]["VAL_RANGE_TOTAL"]["LOW"];
							$valore_val_range_total_high = $guue["AWARD_CONTRACT"]["ITEM_".$item]["VALUES"]["VAL_RANGE_TOTAL"]["HIGH"];
						}
						?>
						...
						<td>
							<input type="text" title="Offerta pi&ugrave; bassa" value="<?= $valore_val_range_total_low ?>" name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_RANGE_TOTAL][LOW]" <?= !$val_range_total ? 'disabled="disabled"' : null ?> id="item_<?= $item ?>_valore_val_range_total_low" rel="S;1;0;2D">
						</td>
						<td>
							<input type="text" title="Offerta pi&ugrave; bassa" value="<?= $valore_val_range_total_high ?>" name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_RANGE_TOTAL][HIGH]" <?= !$val_range_total ? 'disabled="disabled"' : null ?> id="item_<?= $item ?>_valore_val_range_total_high" rel="S;1;0;2D">
						</td>
					</tr>
					<tr>
						<td class="etichetta" colspan="4">
			...
			<input type="hidden" <?= !$val_range_total ? 'disabled="disabled"' : null ?> id="val_range_total_currency_item_<?= $item ?>" name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][VALUES][VAL_RANGE_TOTAL][ATTRIBUTE][CURRENCY]" value="EUR">
		</td>
	</tr>
	<tr>
		<td class="etichetta" colspan="4">
