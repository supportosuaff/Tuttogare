...
?>
<h2 style="text-align: right;"><b>Avviso relativo al profilo di committente</b></h2>
<input type="hidden" name="tipologia_form" value="F08_2014">
<input type="hidden" name="numero_form" value="81">
...
<input type="hidden" name="attributi_form[FORM]" value="F08">
...
<p style="text-align: right;">
	Avviso periodico indicativo (Direttiva 2014/25/UE)<br>
	<i>(non utilizzato come mezzo di indizione di gara)</i>
</p>
<?
	$rel = array(
		"ADDRS1-OFFICIALNAME",
	...
	$_SESSION["guue"]["numero_del_form"] = "f08-1";
			...
			0 => "<h2><b>Sezione II: Oggetto</b></h2>",
				1 => array(
					...
					2 => array(
						...
						// 7 => "sezioni/sezione_2_1_6_f01-1.php",
						8 => '</tbody></table>',
						),
					3 => array(
