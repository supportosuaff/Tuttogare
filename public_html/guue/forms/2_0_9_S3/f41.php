...
<input type="hidden" name="numero_form" value="041">
...
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="PER_ONLY">
<p style="text-align: right;" title="Tipologia di Avviso">
	Direttiva 2014/25/UE<br>
	<label>Il presente avviso &egrave; solo un avviso periodico indicativo</label>
</p>
<?
	$rel = array(
		"ADDRS1-OFFICIALNAME",
	...
	$_SESSION["guue"]["numero_del_form"] = "f04-1";
	...
	$f21 = array(
		0 => array(
			...
			1 => array(
				...
				2 => "sezioni/sezione_1_3_f041.php",
