...
?>
<h2 style="text-align: right;"><b>Servizi sociali e altri servizi specifici - Appalti pubblici</b></h2>
<input type="hidden" name="tipologia_form" value="F21_2014">
<input type="hidden" name="numero_form" value="214">
...
<input type="hidden" name="attributi_form[FORM]" value="F21">
...
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f21-4";
	...
	$f21 = array(
			...
			0 => "<h2><b>Sezione II: Oggetto</b></h2>",
				1 => array(
					...
					2 => array(
						...
						6 => "sezioni/sezione_2_1_7.php",
						7 => "sezioni/sezione_2_1_6_f211.php",
		...
		4 => array(
			...
			1 => "common/more_lots_button_award_f21.php",
			2 => array(),
			3 => "common/more_lots_award.php",
			4 => "common/more_lots_button_award_f21.php",
			),
		5 => array(
