...
?>
<h2 style="text-align: right;"><b>Servizi sociali e altri servizi specifici – Concessioni</b></h2>
<input type="hidden" name="tipologia_form" value="F23_2014">
<input type="hidden" name="numero_form" value="233">
...
<input type="hidden" name="attributi_form[FORM]" value="F23">
...
<input type="hidden" name="guue[NOTICE][ATTRIBUTE][TYPE]" value="CONCESSION_AWARD_CONTRACT">
<p style="text-align: right;" >
	Direttiva 2014/23/UE<br>
	<i>Avviso di preinformazione (pubblicato da un&#39;amministrazione aggiudicatrice)</i>
</p>
<?
	$rel = array(
		"ADDRS1-OFFICIALNAME",
	...
	$_SESSION["guue"]["numero_del_form"] = "f23-1";
