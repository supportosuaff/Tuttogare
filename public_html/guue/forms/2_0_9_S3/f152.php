...
<input type="hidden" name="numero_form" value="152">
...
<input type="hidden" name="guue[DIRECTIVE][ATTRIBUTE][VALUE]" value="2014/24/UE">
<p style="text-align: right; margin-top: 0px">Direttiva 2014/24/UE</p>
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f15-2";
  ...
  if(!empty($_SESSION["guue"]["codice_pubblicazione"])) {
	...
	if(!empty($guue["PROCEDURE"]["DIRECTIVE_2014_24_EU"]["radio_as_select_for_procedure_type"])) {
		if($guue["PROCEDURE"]["DIRECTIVE_2014_24_EU"]["radio_as_select_for_procedure_type"] == "PT_NEGOTIATED_WITHOUT_PUBLICATION") {
			$f03[5][1] = "sezioni/annex_d1_part1.php";
		} else if ($guue["PROCEDURE"]["DIRECTIVE_2014_24_EU"]["radio_as_select_for_procedure_type"] == "PT_AWARD_CONTRACT_WITHOUT_CALL") {
			$f03[5][1] = "sezioni/annex_d1_part2.php";
		}
	}
