...
<table id="<?= !empty($change_item) ? 'change_item_'.$change_item : null ?>" class="bordered">
	<tbody>
		...
		<tr>
			...
			<td>
				<input style="font-size: 1.3em" type="text" name="guue[CHANGES][CHANGE][ITEM_<?= $change_item ?>][WHERE][LOT_NO]" value="<?= !empty($guue["CHANGES"]["CHANGE"]["ITEM_".$change_item]["WHERE"]["LOT_NO"]) ? $guue["CHANGES"]["CHANGE"]["ITEM_".$change_item]["WHERE"]["LOT_NO"] : null?>" rel="N;0;11;N" title="Numero del lotto">
			</td>
		</tr>
		<tr>
			<td class="etichetta">
