<?
	...
	<tr>
		...
		<td colspan="6">
			...
			if(!empty($guue["AWARD_CONTRACT"]["ITEM_".$item]["AWARDED_CONTRACT"]["CONTRACTORS"]["CONTRACTOR"]["ITEM_".$contractor]["radio_as_select_for_is_an_sme"])) {
				$radio_as_select_for_is_an_sme = $guue["AWARD_CONTRACT"]["ITEM_".$item]["AWARDED_CONTRACT"]["CONTRACTORS"]["CONTRACTOR"]["ITEM_".$contractor]["radio_as_select_for_is_an_sme"];
			}
			?>
			<select name="guue[AWARD_CONTRACT][ITEM_<?= $item ?>][AWARDED_CONTRACT][CONTRACTORS][CONTRACTOR][ITEM_<?= $contractor ?>][radio_as_select_for_is_an_sme]" rel="S;1;0;A" title="Contraente PMI">
