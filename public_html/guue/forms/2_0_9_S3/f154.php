...
<input type="hidden" name="numero_form" value="154">
...
<input type="hidden" name="guue[DIRECTIVE][ATTRIBUTE][VALUE]" value="2009/81/CE">
<p style="text-align: right; margin-top: 0px">Direttiva 2009/81/CE</p>
<?
		...
		2 => array(
			...
			1 => array(
				0 => array(
					...
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_4_1_1_f15-4.php",
