...
?>
<h2 style="text-align: right;"><b>Bando di Gara</b></h2>
<input type="hidden" name="tipologia_form" value="F02_2014">
<input type="hidden" name="numero_form" value="2">
...
<input type="hidden" name="attributi_form[FORM]" value="F02">
...
<?
	...
	$_SESSION["guue"]["numero_del_form"] = "f02";
		...
		3 => array(
			...
			1 => array(
				0 => array(
					...
					1 => '<table class="bordered"><tbody>',
					2 => "sezioni/sezione_4_1_1_f02.php",
					3 => "sezioni/sezione_4_1_3.php",
					4 => "sezioni/sezione_4_1_4.php",
					5 => "sezioni/sezione_4_1_5.php",
