...
<p style="text-align: right;" title="Tipologia di Avviso">
	...
	<label>Il presente avviso &egrave; soltanto un avviso di preinformazione</label>
</p>
<?
	$rel = array(
	...
	$f01 = array(
		0 => array(
			...
			1 => array(
				...
				2 => "sezioni/sezione_1_3_f01-1.php",
  ...
  } else if(!empty($_SESSION["guue"]["codice_gara"])) {
