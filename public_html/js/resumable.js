  ...
  var Resumable = function(opts){
    ...
    $.defaults = {
      ...
      maxFilesErrorCallback:function (files, errorCount) {
        ...
        alert('Si prega di caricare massimo ' + maxFiles + ' file' + (maxFiles === 1 ? '' : 's') + ' alla volta.');
      },
      minFileSize:1,
      minFileSizeErrorCallback:function(file, errorCount) {
        alert(file.fileName||file.name +' è troppo piccolo, si prega di caricare files maggiori di ' + $h.formatSize($.getOpt('minFileSize')) + '.');
      },
      maxFileSize:undefined,
      maxFileSizeErrorCallback:function(file, errorCount) {
        alert(file.fileName||file.name +' è troppo grande, si prega di caricare files minori di ' + $h.formatSize($.getOpt('maxFileSize')) + '.');
      },
      fileType: [],
      fileTypeErrorCallback: function(file, errorCount) {
        alert(file.fileName||file.name +' è di tipo non consentito, si prega di caricare files di tipo ' + $.getOpt('fileType') + '.');
      }
    };
    $.opts = opts||{};
    $.getOpt = function(o) {
