...
?>
        ...
        <table width="100%">
            <tr>
            	<td width="15"><? if ($espandi) { ?><button onClick="carica_categorie('<? echo $rec_categorie["codice"] ?>','<? echo $lista ?>','/albo/filtro_categorie/albero.php');return false;"><img width="10" id="espandi_<? echo $rec_categorie["codice"] ?>" src="/img/espandi.png" alt="Espandi/Contrati"></button><? } ?></td>
                <td width="50"><? echo $rec_categorie["codice"] ?></td>
                <td><? echo $rec_categorie["descrizione"] ?></td>
                <? if (!isset($albero) || $lista == "all") { ?><td width="15"><input type="image" src="/img/<? echo $image ?>"  onClick="categoria('<? echo $rec_categorie["codice"] ?>','<? echo $lista ?>','/albo/filtro_categorie/categoria.php');return false;" width="16"></td><? } ?>
             </tr>
        </table>
