<?
    if (isset($_POST["id"])) {
        ...
        $modulo = get_campi("b_modulistica_dialogo");
        $id = $_POST["id"];
    }
    if (isset($modulo)) {
?>
            <tr id="modulo_<?= $id ?>">
                ...
                <td width="10">
                <input type="image" onClick="elimina('<? echo $id ?>','dialogo_competitivo/modulistica');return false;" src="/img/del.png" title="Elimina">
                </td>
            </tr>
    <? } ?>
