	...
	?>
        ...
        <div class="comandi">
              ...
              <div id="tipologie_tabs">
             	...
             	<button class="aggiungi" onClick="aggiungi('form.php','#tipologie_tabs');return false;"><img src="/img/add.png" alt="Aggiungi tipologia">Aggiungi tipologia</button>
                        </div>
