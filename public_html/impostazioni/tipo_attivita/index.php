<?
	...
	echo "<h1>TIPOLOGIE ATTIVITA'</h1>";
		if ($_SESSION["gerarchia"] === "0") {
			$strsql = "SELECT * FROM b_tipo_attivita WHERE eliminato = 'N' ORDER BY codice ";
	...
	?>
        ...
        <div class="comandi">
                ...
                <table width="100%" >
                  ...
                  <tfoot>
                  	<tr><td colspan="5">
											<button class="aggiungi" onClick="aggiungi('form.php','#attivita_tabs');return false;"><img src="/img/add.png" alt="Aggiungi tipologia">Aggiungi tipologia</button></td>
										</tr>
									</tfoot>
								</table>
							</div>
