<?
	...
	if ($edit) {
	echo "<h1>MODALITA DI PARTECIPAZIONE</h1>";
        ...
        <div class="comandi">
        			...
        			<div class="box">
                        <table width="100%" >
                            ...
                            <tfoot>
                            <tr><td colspan="4">
                       <button class="aggiungi" onClick="aggiungi('form.php','#modalita_tabs');return false;"><img src="/img/add.png" alt="Aggiungi modalita">Aggiungi modalita</button></td></tr>
                            </tfoot>
                           </table>
                        </div>
