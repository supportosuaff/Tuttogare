<?
	...
	if ($edit && !$lock) {
			...
			$sql = "DELETE FROM r_dgue_gare WHERE codice_gara = :codice_gara AND sezione = 'concorsi' ";
			...
			log_concorso($_SESSION["ente"]["codice"],$codice_gara,"UPDATE","Configurazione DGUE");
