...
(function(window, document, $, undefined)
 {
    window.ResumableUploader = function(browseTarget,signed) {
     ...
     this.newResumable = function(){
       ...
       this.resumable.on('fileAdded', function(file){
		   var allReg = /\.(p7m|P7M)$/;	// espressione regolare per il controllo dei file allegati
       if (!signed) allReg = /\.(pdf|PDF|zip|ZIP|rar|RAR|7z|7Z)$/;	// espressione regolare per il controllo dei file allegati
    ...
    loadNext();
        ...
        permitted = "P7M";
        if (!signed) permitted = "PDF, ZIP, RAR o 7Z";

			  jalert("<div style=\"text-align:center\">Impossibile caricare il file<br><br><strong>" + file.fileName + "</strong></br><br>La tipologia pu&ograve; solo essere: " + permitted +"</div>");
