        ...
        <table width="100%">
          <tr>
            <td colspan="2" class="etichetta" style="text-align:center">
              <strong>L'operatore economico ha preso misure per dimostrare la propria affidabilit&agrave; ("autodisciplina")? </strong><br>
          ...
          <tr class="autodisciplina_<?= $form["codice"] ?>" <? if ($values["_01"][0] != "true") echo "style='display:none'" ?>>
            <td style="text-align:center">
            <strong>E' stato risarcito interamente il danno?</strong><br>
              <label>Si</label>
              ...
              <input type="radio"
                ...
                class="form_autodisciplina_<?= $form["uuid"] ?>_<?= $id_repeat ?>"
                 ...
                 <br>
               <br><strong>Si &egrave; impegnato formalmente a risarcire il danno?</strong><br>
               <label>Si</label>
          ...
          <tr class="autodisciplina_<?= $form["codice"] ?>" <? if ($values["_01"][0] != "true") echo "style='display:none'" ?>>
            <td colspan="2" style="text-align:center">
              <strong>Indicare le misure di carattere tecnico o organizzativo e relative al personale, eventualmente adottate, idonee a prevenire ulteriori illeciti o reati, la relativa documentazione e se disponibile elettronicamente indicare (indirizzo web, autorit&agrave; o organismo di emanazione, riferimento preciso della documentazione):</strong><br>
