  ...
  if (isset($form)) {
    ...
    <div id="criteria_<?= $form["codice"] ?>" <? if ($values["_0"][0] != "false") echo "style='display:none'" ?>>
        <table width="100%">
          <tr>
            <td class="etichetta">
              In caso negativo, spiegare perché e precisare di quali altri mezzi di prova relativi al programma di garanzia della qualit&agrave; si dispone:
            </td>
            <td>
              <input type="hidden" name="espd[ccv:Criterion][<?= $form["uuid"] ?>][ccv:RequirementGroup][0][ccv:Requirement][1][cbc:ID][$]" value="8c5d1e13-54f7-4895-a65c-b8e09253130c">
