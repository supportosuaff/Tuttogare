...
;
    ...
    $sql_form = "SELECT * FROM b_dgue_settings WHERE uuid = :uuid AND version = '2050-16'";
                ...
                <td>
                  <table width="100%">
                    ...
                    <tr>
                      <td class="etichetta">
                        <strong>
                          2) La sentenza definitiva di condanna prevede una pena detentiva non superiore a 24 mesi?
                        </strong>
                      </td>
                    </tr>
                    <tr>
