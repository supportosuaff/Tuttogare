  ...
  if (isset($form)) {
    ...
    <div id="criteria_<?= $form["codice"] ?>" <? if ($values["_0"][0] != "true") echo "style='display:none'" ?>>
        <table width="100%">
          ...
          <?
            for ($c_s=1;$c_s<=3;$c_s++) {
              ...
              <tr>
                ...
                <input type="hidden" name="espd[ccv:Criterion][<?= $form["uuid"] ?>][ccv:RequirementGroup][ccv:RequirementGroup][<?= $c_s ?>][cbc:ID][$]" value="PERS_SUBAPPALTO_<?= $c_s ?>">
              </tr>
              <tr>
                <td>
                  <table width="100%">
                    <tr>
                      ...
                      <td>
                        <input type="hidden" class="subappaltatori" name="espd[ccv:Criterion][<?= $form["uuid"] ?>][ccv:RequirementGroup][ccv:RequirementGroup][<?= $c_s ?>][ccv:Requirement][0][cbc:ID][$]" value="PERS_RAGIONE_SOCIALE_<?= $c_s ?>">
                        <input type="text" rel="N;0;0;A" name="espd[ccv:Criterion][<?= $form["uuid"] ?>][ccv:RequirementGroup][ccv:RequirementGroup][<?= $c_s ?>][ccv:Requirement][0][ccv:Response][cbc:Description]" value="<?= $values["_0".$c_s][0] ?>" style="width:95%" class="subappaltatori dgue_input">
                      </td>
                    </tr>
                    <tr>
                      <td>Partita IVA</td>
                      <td>
                        <input type="hidden" class="subappaltatori" name="espd[ccv:Criterion][<?= $form["uuid"] ?>][ccv:RequirementGroup][ccv:RequirementGroup][<?= $c_s ?>][ccv:Requirement][1][cbc:ID][$]" value="PERS_PARTITA_IVA_<?= $c_s ?>">
                        <input type="text" rel="N;11;0;CFPI" name="espd[ccv:Criterion][<?= $form["uuid"] ?>][ccv:RequirementGroup][ccv:RequirementGroup][<?= $c_s ?>][ccv:Requirement][1][ccv:Response][cbc:Description]" value="<?= $values["_0".$c_s][1] ?>" style="width:95%" class="subappaltatori dgue_input">
                      </td>
                    </tr>
                  </table>
                </td>
          ...
          <tr>
            <td>
              <input type="hidden" class="subappaltatori" name="espd[ccv:Criterion][<?= $form["uuid"] ?>][ccv:RequirementGroup][ccv:Requirement][2][cbc:ID][$]" value="PERS_DESCRIZIONE_SUBAPPALTO">
